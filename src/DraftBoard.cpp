...
DraftBoard::DraftBoard() {
    ...
    */
    ...
    _draftBoard[0].setName("Andrewsaurus");
    _draftBoard[1].setName("Willzilla");

    // Monster* Andrewsaurus = new Monster();
    // Monster* Willzilla = new Monster("Willzilla");

    // Andrewsaurus->setName("Andrewsaurus");

    // _draftBoard.push_back(Andrewsaurus);
    // _draftBoard.push_back(Willzilla);
